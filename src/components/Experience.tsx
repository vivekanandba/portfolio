...
// bodies of work rather than an undifferentiated "more work" list. Order mirrors
// the featured grid and the timeline (most-recent domain first).
    ...
    <Section id="work" eyebrow="Selected Work" title="Zero-to-one products, shipped">
      ...
      {secondaryProjects.length > 0 && (
        <div className="mt-16">
          ...
          {CHAPTER_ORDER.map((domain) => {
            const group = secondaryProjects.filter((p) => p.domain === domain);
